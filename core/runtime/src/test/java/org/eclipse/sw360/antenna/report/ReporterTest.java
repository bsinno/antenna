...
public class ReporterTest {
    ...
    public void init(){
        ...
        id = ArtifactCoordinatesUtils.mkMavenCoordinates("testAid","testGid","testVer");
    ...
    public void testAddMessageWithNullArtifactIdentifier() {
        reporter.add(new ArtifactCoordinates("Name","Version"), MessageType.MISSING_COORDINATES, msg);
